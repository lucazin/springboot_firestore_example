...
public class FirestoreSampleApp {
		...
		return args -> {
			...
			try {
				FirebaseOptions options = new FirebaseOptions.Builder()
						.setCredentials(
								GoogleCredentials.fromStream(Files.newInputStream(new File(String.valueOf(
										ResourceUtils.getFile("classpath:servicekey.json"))).toPath())))
						.build();
	...
	private void writeDocumentFromMap_async() throws InterruptedException, java.util.concurrent.ExecutionException {
...
//						System.out.println("atualizado " + documentSnapshot.toString());
//						//registration.remove();
//					}
//				});
